...
# Data was not shuffled but sequentially shuffled
...
def main():
    print 'SVM accuracy: ' + str(performSVMClass(X_train, y_train, X_test, y_test, [1, 'linear']))
    print 'SVM accuracy: ' + str(performSVMClass(X_train, y_train, X_test, y_test, [1, 'rbf']))
    print 'SVM accuracy: ' + str(performSVMClass(X_train, y_train, X_test, y_test, [1, 'sigmoid']))
    print 'SVM accuracy: ' + str(performSVMClass(X_train, y_train, X_test, y_test, [1, 'poly']))
